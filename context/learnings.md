...
2. **ANETVA** still the ES yield engine: Descuelgue + Eix cards **re-dated 15 Sep 2026**; Dominion Portugal **14 Sep** is IRATA 3 + Spanish papers → stretch only.
3. **FR query layer NEW:** Altifusion Lyon (IRATA OK), ACCÈS SERVICE Normandie, SIGEDI nucléaire — all FR-language workplace.
4. **DE NEW:** IKH Hamburg FISAT L1–3 evergreen; Brand Energy Den Helder now **OFFLINE** → Company watch.
5. **UK:** High Torque careers is a clean L1/L2 employer page (promoted from seed); Pendrich closed.
6. **Norway:** StS UK English path remains the usable EU-passport route; 7ocean / StS-ISONOR / **KAEFER Tilkomst (deadline 30 Sep)** all demand NS 9600 + Scandinavian.
7. **Aerones NEW** English blade/robotics Europe campaign — certs fit, blade-hours stretch for Luis.
8. Best English + cert fit: Fender NL → High Torque UK → Swire/RAS blade 2026 → Gridinta → Bilfinger NL → StS Norway via UK → SPIE Wind → Aerones (stretch) → CGS Nordic (deadline 30 Sep).

## 2026-09-14 (Monday)

1. **Fender BV (Ridderkerk)** is a strong NEW NL query-layer employer: English + IRATA + EU passport + housing/flights — high English-realistic apply priority.
2. **ANETVA** still the ES yield engine: Descuelgue + Eix cards **re-dated 14 Sep 2026** — refreshed Live, not brand-new firms.
3. Monday long-tail **IT** paid off: **2High Lombardia** operatore in fune still open (Italian required).
...
6. Best English + cert fit: Fender NL → Swire/RAS blade 2026 → Gridinta → Bilfinger NL → Sky-Access → StS Norway via UK → SPIE Wind → RES palas → CGS Nordic.

## 2026-09-11 (Friday)

1. Sky-Access (Roosendaal) NEW NL query-layer employer.
2. ANETVA highest-yield ES board — open each card.
3. France Travail detail offers beat emploi-cordiste partner shells.
4. Norway: StS UK path usable; pure NO ads need NS 9600 + Scandinavian.
5. Altrad NL Recruitee L3 links 404 → Company watch.
6. Rigg Access / Indeed often agent-hostile.
